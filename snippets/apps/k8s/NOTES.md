...
```
helm -n kubauth upgrade -i kubauth-kubeconfig --values ./values-kubeconfig.yaml oci://quay.io/kubauth/charts/kubauth-kubeconfig --version 0.2.0 --create-namespace --wait
```
